...
function NavMobile({ isOpen, setIsOpen }) {
  return (
    <nav
      className={`fixed top-0 left-0 w-full h-full bg-orange-600 bg-opacity-90 text-white flex flex-col items-center justify-center transition-transform transform ${
